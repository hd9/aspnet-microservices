    ...
    public class CatalogSvc : ICatalogSvc
    {
        ...
        public CatalogSvc(HttpClient httpClient, IConfiguration cfg, ILogger<CatalogSvc> logger)
        {
            ...
            products = new List<Product>
            {
                ...
                new Product { Id = "gcd-5041", Name = "Gaming Computer Desk with Storage for Controller, Headphone & Speaker - Black", Price = 159.71, Currency = "CAD", Description = "TODO", CategoryId = "headphones-audio", CategoryName = "Headphones & Audio", Rating = 4 },
