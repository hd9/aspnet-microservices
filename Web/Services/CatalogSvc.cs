    ...
    public class CatalogSvc : ICatalogSvc
    {
        ...
        public CatalogSvc(HttpClient httpClient, IConfiguration cfg, ILogger<CatalogSvc> logger)
        {
            ...
            products = new List<Product>
            {
                ...
                new Product { Id = "alg-4445", Name = "Algorithms", Price = 45, Currency = "CAD", Description = " by Robert Sedgewick & Kevin Wayne TODO", CategoryId = "books", CategoryName = "Books", Rating = 3 } ,
                ...
                new Product { Id = "bstd3-789", Name = "Beats Studio3 Wireless Headphones, Matte Black", Price = 400, Currency = "CAD", Description = "TODO", CategoryId = "headphones-audio", CategoryName = "Headphones & Audio", Rating = 4 },
                new Product { Id = "smb-506041", Name = "Sennheiser MB Pro 1 (506041)", Price = 166, Currency = "CAD", Description = "TODO", CategoryId = "headphones-audio", CategoryName = "Headphones & Audio", Rating = 4 },
                new Product { Id = "gcd-5041", Name = "Gaming Computer Desk with Storage for Controller, Headphone & Speaker - Black", Price = 159.71f, Currency = "CAD", Description = "TODO", CategoryId = "headphones-audio", CategoryName = "Headphones & Audio", Rating = 4 },
